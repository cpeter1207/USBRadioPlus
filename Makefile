...
ifeq ($(shell $(PKG_CONFIG) --atleast-version=0.2.0~alpha3 rptadv_portaudio_alsa_adapter && echo yes),)
$(error USBRadioPlus requires librptadv-portaudio-alsa-adapter-dev 0.2.0~alpha3 or newer)
endif
