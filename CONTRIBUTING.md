...
failures as errors on Debian 13 for amd64 and arm64. Production-code line and
branch coverage is required on amd64; arm64 runs the platform test, package,
and staged-install checks. Debian 12 builds are aspirational and are run
manually only when explicitly requested.
